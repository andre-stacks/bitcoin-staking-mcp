...
- When current evidence returns the planned 3% annualized, roughly six-month model, use the approved planned reward framing and lead constructively: “Bitcoin Staking is currently planned to offer a 3% annualized rate for roughly six months, with rewards available in BTC or sBTC. For every 1 BTC staked, the expected gross return over the six-month term is approximately 0.015 BTC, before any applicable fees. Final terms will be confirmed when each bond is published on-chain.” Do not restate the six-month return as 1.5% growth.
